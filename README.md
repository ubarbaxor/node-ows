...
- [Module](#module)
  - [ows.createClient(url[, options], callback) - create a new OWS client from a getCapabilities url. Also supports a local filesystem path.](#owscreateclienturl-options-callback---create-a-new-ows-client-from-a-getcapabilities-url-also-supports-a-local-filesystem-path)
  - [Options](#options)
  - [OWS Fault](#ows-fault)
- [OWS Headers](#ows-headers)
  - [Received OWS Headers](#received-ows-headers)
  - [Outgoing OWS Headers](#outgoing-ows-headers)
- [Client](#client)
  ...
  - [Client.*method*(args, callback) - call *method* on the OWS service.](#clientmethodargs-callback---call-method-on-the-ows-service)
  - [Client.*service*.*version*.*method*(args, callback[, options[, extraHeaders]]) - call a *method* using a specific *service* and *version*](#clientserviceversionmethodargs-callback-options-extraheaders---call-a-method-using-a-specific-service-and-version)
  - [Client.*lastRequest* - the property that contains last full ows request for client logging](#clientlastrequest---the-property-that-contains-last-full-ows-request-for-client-logging)
  - [Client.setEndpoint(url) - overwrite the OWS service endpoint address](#clientsetendpointurl---overwrite-the-ows-service-endpoint-address)
...
- [Handling XML Attributes, Value and XML (getCapabilitiesOptions).](#handling-xml-attributes-value-and-xml-getcapabilitiesoptions)
...
* Supports multiRef OWS messages (thanks to [@kaven276](https://github.com/kaven276))
